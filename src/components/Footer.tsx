...
const LINKEDIN_URL = 'https://www.linkedin.com/company/parentbud/';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              ...
              <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-sm text-slate-400 hover:text-white transition-colors">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-8 border-t border-white/[0.06]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full bg-white/[0.06] border border-white/[0.08] hover:bg-[#0077b5] hover:border-transparent transition-all" aria-label="LinkedIn">
